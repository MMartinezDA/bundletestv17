  ...
  _CreateSaleOrderLine: function (ev) {
    ...
    bundle_products.each(function () {
      if ($(this).hasClass("dynamic_field")) {
        ...
        var original_price = parseFloat($(this).closest(".add_advance_product").find(".advanced_product_price .wk_adv_price span").parent().data('original-price'))
        ...
        data.push([_id, qty, bundle_price,original_price]);
      } else {
        var _id = parseInt($(this).val());
        var qty = parseInt(
